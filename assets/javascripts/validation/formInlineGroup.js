...
/**
 ...
 <form action="..." method="POST"
      class="form js-form js-form-grouped-elements"
   ...
   <fieldset class="form-field-group touch" id="date">
      ...
      <div class="form-date form-field-group  full-width">
        ...
        <ul class="error-notification error-notification--group list--inline group" data-group-list="date">
...
var form = require('./form.js'),
  ...
  init = function() {
    $groups = $('.js-form-grouped-elements');
    if ($groups.length) {
